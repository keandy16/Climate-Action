...
action<-selectInput("action", h3("Choose your Preferred Action"),
...
affinity<- selectInput("affinity", h3("Choose a Co-dependent Issue"),
...
state<- selectInput("state", h3("Choose your State"),
                    choices = c("Montana",
                                "New Hampshire",
                                "Missouri",
                                "California"),
                    selected = "Montana")
region<- selectInput("region", h3("Choose a Region"),
                     choices = c("Northeast", 
                                 "Southeast",
                                 "Midwest", 
...
server <- function(input, output){
  ...
  output$ui <- renderUI({
    ...
    switch(input$setting,
           "Virtual" = selectInput("action", h3("Choose your Preferred Action"),
                                   choices = c( "Social Media",
                                                "Protesting",
                                                "Data Entry",
                                                "Sign a Petition",
  ...
  output$ui_next <- renderUI({
    ...
    if(output$ui = input$action){
      switch(input$action,
             "Social Media" = affinity,
             "Protesting" = affinity,
             "Data Entry" = affinity,
             "Sign a Petition" = affinity,
             "Calls to Citizens" = affinity,
             "General Assistance" = affinity,
             "Contacting Decision Makers" = affinity,
             "Tabling Events" = affinity,
             "Canvassing" = affinity,
             "Other" = affinity)
    }
  ...
  output$ui_three <- renderUI({
    if(input$state){
      switch(input$state,
             ...
             "Montana" = selectInput("involve", h3("Choose your Preferred Action"),
                                     choices = c( "Social Media",
                                                  "Protesting",
                                                  "Data Entry",
                                                  "Sign a Petition",
                                                  ...
                                                  "Other"),
                                     selected = "Social Media"),
             "New Hampshire" = selectInput("involve", h3("Choose your Preferred Action"),
                                           choices = c( "Social Media",
                                                        "Protesting",
                                                        "Data Entry",
                                                        "Sign a Petition",
                                                        ...
                                                        "Other"),
                                           selected = "Social Media"),
             "Missouri" = selectInput("involve", h3("Choose your Preferred Action"),
                                      choices = c( "Social Media",
                                                   "Protesting",
                                                   "Data Entry",
                                                   "Sign a Petition",
                                                   ...
                                                   "Other"),
                                      selected = "Social Media"),
             "California" = selectInput("involve", h3("Choose your Preferred Action"),
                                        choices = c( "Social Media",
                                                     "Protesting",
                                                     "Data Entry",
                                                     "Sign a Petition",
  ...
  elseif(input$region)
    switch(input$region,
           "Northeast" = selectInput("involve", h3("Choose your Preferred Action"),
                                     choices = c( "Social Media",
                                                  "Protesting",
                                                  "Data Entry",
                                                  "Sign a Petition",
                                                  ...
                                                  "Other"),
                                     selected = "Social Media"), 
           "Southeast" = selectInput("involve", h3("Choose your Preferred Action"),
                                     choices = c( "Social Media",
                                                  "Protesting",
                                                  "Data Entry",
                                                  "Sign a Petition",
                                                  ...
                                                  "Other"),
                                     selected = "Social Media"),
           "Midwest" = selectInput("involve", h3("Choose your Preferred Action"),
                                   choices = c( "Social Media",
                                                "Protesting",
                                                "Data Entry",
                                                "Sign a Petition",
                                                ...
                                                "Other"),
                                   selected = "Social Media"), 
           "Northern Great Plains" = selectInput("involve", h3("Choose your Preferred Action"),
                                                 choices = c( "Social Media",
                                                              "Protesting",
                                                              "Data Entry",
                                                              "Sign a Petition",
                                                              ...
                                                              "Other"),
                                                 selected = "Social Media"),
           "Southern Great Plains" = selectInput("involve", h3("Choose your Preferred Action"),
                                                 choices = c( "Social Media",
                                                              "Protesting",
                                                              "Data Entry",
                                                              "Sign a Petition",
                                                              ...
                                                              "Other"),
                                                 selected = "Social Media"), 
           "Northwest" = selectInput("involve", h3("Choose your Preferred Action"),
                                     choices = c( "Social Media",
                                                  "Protesting",
                                                  "Data Entry",
                                                  "Sign a Petition",
                                                  ...
                                                  "Other"),
                                     selected = "Social Media"),
           "Southwest" = selectInput("involve", h3("Choose your Preferred Action"),
                                     choices = c( "Social Media",
                                                  "Protesting",
                                                  "Data Entry",
                                                  "Sign a Petition",
                                                  ...
                                                  "Other"),
                                     selected = "Social Media"),
           "Alaska" = selectInput("involve", h3("Choose your Preferred Action"),
                                  choices = c( "Social Media",
                                               "Protesting",
                                               "Data Entry",
                                               "Sign a Petition",
                                               ...
                                               "Other"),
                                  selected = "Social Media"),
           "Hawaii & Pacific Islands" = selectInput("involve", h3("Choose your Preferred Action"),
                                                    choices = c( "Social Media",
                                                                 "Protesting",
                                                                 "Data Entry",
                                                                 "Sign a Petition",
                                                                 ...
                                                                 "Other"),
                                                    selected = "Social Media"),
           "Caribbean" = selectInput("involve", h3("Choose your Preferred Action"),
                                     choices = c( "Social Media",
                                                  "Protesting",
                                                  "Data Entry",
                                                  "Sign a Petition",
